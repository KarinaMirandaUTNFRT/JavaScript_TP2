const textoUsuario = prompt("Inngresá el texto que quieras convertir en mayusculas:");
if (textoUsuario !== null) { //Validamos que el usuario no haya presionado "Cancelar" (null)
   ...
   alert("Tu texto en mayúsculas es:\n" + textoMayusculas);
    document.write("<h3>Resultado: " + textoMayusculas + "</h3>");
